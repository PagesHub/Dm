...
import com.yang.sdk.constant.PermissionConstants;
...
public final class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(SdkUtils.getApp().getPackageName());
    }
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(SdkUtils.getApp(), permission);
    }
    ...
    public static void openAppSettings() {
        ...
        intent.setData(Uri.parse("package:" + SdkUtils.getApp().getPackageName()));
        SdkUtils.getApp().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    private void startPermissionActivity() {
        ...
        PermissionActivity.start(SdkUtils.getApp());
    }
