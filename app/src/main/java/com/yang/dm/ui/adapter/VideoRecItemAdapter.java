 ...
 */
public class VideoRecItemAdapter extends BaseQuickAdapter<ReadClassifyChild, BaseViewHolder> {

    public VideoRecItemAdapter(@Nullable List<ReadClassifyChild> data) {
